        ...
        <section ref={sectionRef} className="reveal py-14">
          <div className="w-full bg-[#F3E7B3]/70 rounded-2xl p-6 md:p-10 shadow-lg">
            ...
            <div className="grid md:grid-cols-3 gap-6 items-stretch">
              ...
              <div className="card-glow gradient-border rounded-xl p-6 bg-[#F3E7B3]/80">
                ...
                <p className="text-sm mt-3">Morning: 7:25 – 1:00</p>
              </div>
              ...
              <div className="card-glow gradient-border rounded-xl p-6 bg-[#F3E7B3]/80">
                ...
                <p className="text-sm mt-3">Morning: 8:15 – 9:00</p>
              </div>
              ...
              <div className="card-glow gradient-border rounded-xl p-6 bg-[#F3E7B3]/80">
                ...
                <p className="text-sm mt-3">Morning: 7:30 – 1:00</p>
                <p className="text-sm mt-3">Vacation: 9:00 – 12:00</p>
              </div>
